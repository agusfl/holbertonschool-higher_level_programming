...
Este ejercicio es practicamente igual al task 6 pero en este caso hay que
imprimir el resultado de la clase y para hacer esto sin que nos imprima
solo el nombre de la clase y la direccion de memoria hay que usar el metodo
__str__ ya que nos piden que: Printing a Square instance should have the same behavior as my_print().
"""
    ...
    def __str__(self):
        ...
        if self.size == 0:
            ...
            for pos in range(self.size):
                string += " " * self.__position[0] + "#" * self.size + "\n"
        return string[:-1]
